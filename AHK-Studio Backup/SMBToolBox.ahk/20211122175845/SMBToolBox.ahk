...
RefreshPing:
{
	...
	GuiControl,, PingEditBox, "Edit Box"
	Return
	If WinExist()
	{
		...
		Else {
			...
			if FoundPos
			{
				...
				txt .= now "- Reply from " urlPing ": " tripTime "`n"
			}
		}	
		;GuiControl,, PingEdit, % txt
...
GuiPing()
{
	...
	Gui, 3:Add, Edit, x0 y0 w%width% h%height% vPingEditBox ReadOnly, This is an Edit Box
