...
GuiSettings()
{
	...
	Gui, 2:Font, S19 CDefault Normal, Arial
	Gui, 2:Add, Text, x%xCol_1% y%yTop_Row1_Text% w140 h20, RIP Key:
	;Gui, 2:Add, Text, x%xCol_2% y%yTop_Row2_Text% w140 h20, DNS 1:
	;Gui, 2:Add, Text, x%xCol_3% y%yTop_Row2_Text% w140 h20, DNS 2:
	;Gui, 2:Font, S11 CDefault Normal, Courier
	;Gui, 2:Add, Edit, x%xCol_1% y%yTop_Row2_Obj% w160 +Center, % Presets.rip
	;Gui, 2:Add, Edit, x%xCol_2% y%yTop_Row2_Obj% w160 +Center, % Presets.d1
	;Gui, 2:Add, Edit, x%xCol_3% y%yTop_Row2_Obj% w160 +Center, % Presets.d2
