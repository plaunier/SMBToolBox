...
GuiSettings()
{
	...
	Gui, 2:Add, Button, x73 y170 w140 h25 +Center, Cancel
	Gui, 2:Add, Button, x276 y170 w140 h25 +Center gSettingCancel, Save Changes
	;	Gui, 2:Add, Text, x10 w280 +Center, TODO: Add Settings Menus
	
	
	Gui, 2:Show, w%width% h200 x%WinX% y%WinY%, Default Settings
