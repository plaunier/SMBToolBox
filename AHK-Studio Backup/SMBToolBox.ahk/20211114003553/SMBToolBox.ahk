...
ButtonDHCP:
{
	...
	IfMsgBox Yes
	{
		...
		GuiControl,, ScriptText, Remove-NetIPAddress -PrefixOrigin Manual `; Set-DnsClientServerAddress -InterfaceIndex %AdapterIndex% -ResetServerAddresses `; Set-NetIPInterface -InterfaceAlias %AdaptersDDL% -Dhcp Enabled
		Return
		;Remove-NetIPAddress -PrefixOrigin Manual
		Run, *RunAs PowerShell.exe -Command Remove-NetIPAddress -PrefixOrigin Manual `; Set-DnsClientServerAddress -InterfaceIndex %AdapterIndex% -ResetServerAddresses `; Set-NetIPInterface -InterfaceAlias %AdaptersDDL% -Dhcp Enabled
