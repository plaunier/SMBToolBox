...
OnLoad() {
    ...
    JumpBoxes[2] := ;<add name="NorthEast 2" address="24.24.43.133" port="22" user="bctechcpe" password="T3chBCcp3" default="false"/>
    ;<add name="Test Box" address="192.168.254.210" port="22" user="technician" password="technician" default="false"/>
