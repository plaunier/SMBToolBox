...
GuiSettings()
{
	...
	Gui, 2:Add, Button, x170 y+20 w140 h25 +Center, Save Changes
...
GuiPing()
{
	...
	;Gui, 1:+Disabled
	;Gui, 3:+AlwaysOnTop +LastFound -Resize +HWNDh2Gui
	Gui, 3:+Owner
	Gui, 3:Margin, 10, 10
	;Gui, 2:Font, S20 CDefault Bold, Courier

	;Gui, 3:Font, S10 CDefault Normal, Arial
	Gui, 3:Font, S11 CDefault Normal, Courier
	Gui, 3:Add, Edit, x10 y10 w460 h100

	Gui, 3:Show, w%width% h100 x%WinX% y%WinY%, Ping Gateway
