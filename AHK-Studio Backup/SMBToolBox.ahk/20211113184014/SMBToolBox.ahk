...
ButtonDHCP:
{
	...
	GuiCreate() {
		...
		Gui, Font, S11 CDefault Normal, Courier
		; Gui, Font, S11 CDefault Normal, Arial
		Gui, Add, Edit, x%xCol_1% y+5 h200 w260 HWNDhScriptText vScriptText vscroll
		
		
		
		
		; Status
		Gui, Add, Text, xm y+10 w160 HWNDhStatus,
		; Progress Bar
		Gui Add, Progress, x+20 yp w240 h20 vLoopProgress Border, 0
		...
		Progress, w440,, Getting Adapters..., Processing Console
