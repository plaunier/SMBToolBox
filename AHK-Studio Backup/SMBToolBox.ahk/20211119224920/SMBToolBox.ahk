...
GuiSettings()
{
	...
	Gui, 2:Add, Text, x%xCol_1% y%yTop_Row1_Text% w80 h20, Gateway:
	Gui, 2:Add, Text, x%xCol_2% yp w140 h20, Usable:
	Gui, 2:Add, Text, x%xCol_3% yp w140 h20, SubnetMask:
	Gui, 2:Font, S11 CDefault Normal, Courier
	Gui, 2:Add, Edit, x%xCol_1% y%yTop_Row1_Obj% w160 HWNDhGateway gGW_Label vGateway +Center
	Gui, 2:Add, Edit, x%xCol_2% yp w160 HWNDhUseable gUseableIP_Label vUseable +Center
	Gui, 2:Add, DropDownList, x%xCol_3% yp w160 vSubnetsDDL, 255.255.255.252||255.255.255.248|255.255.255.240|255.255.255.0
