...
ButtonCreateTunnel:
{
	...
	If (ValidIP(TenDot)) {
		...
		;loginArg = "-ssh " + currentValues.currentJumpBox.Address + " -P " + currentValues.currentJumpBox.Port + " -l " + currentValues.currentJumpBox.User + " -pw " + currentValues.currentJumpBox.Password;
		;tunnelArg = "-L 80:" + tboxTenDot.Text + ":80 -L 8080:" + tboxTenDot.Text + ":8080";
...
OnLoad() {
	...
	Gui, 9:+AlwaysOnTop -Caption +Border
	Gui, 9:Margin, 10, 10
	...
	JumpBoxes := []
	JumpBoxes[1] := {"name": "NorthEast 1", "address": "24.24.43.132", "port": "22", "user": "bctechcpe", "password": "T3chBCcp3"}
    JumpBoxes[2] := {"name": "NorthEast 2", "address": "24.24.43.133", "port": "22", "user": "bctechcpe", "password": "T3chBCcp3"}
    JumpBoxes[3] := {"name": "Test Box", "address": "192.168.1.202", "port": "22", "user": "technician", "password": "technician"}
