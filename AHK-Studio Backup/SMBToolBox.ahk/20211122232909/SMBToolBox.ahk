...
GuiSettings()
{
	...
	Gui, 2:Add, Tab3, x10 y10 w470 h150, Defaults||Jump Boxes|Scripts|About|
	...
	Gui, 2:Add, Text, w450 h150 +Center vSettingsJB, Jump Boxes
	
	
	; Tab Scripts
	Gui, 2:Tab, Scripts
	Gui, 2:Add, Text, w450 h150 +Center, Scripts
	...
	; Tab About
	Gui, 2:Tab, About
	Gui, 2:Add, Text, x20 y40 w450 h150 +Center, % aboutTXT
	
	Gui, 2:Tab, ;exit the tabs
	
	Gui, 2:Font, S11 CDefault Bold, Arial
	Gui, 2:Add, Button, x73 y180 w140 h25 +Center gSettingCancel, Cancel
	Gui, 2:Add, Button, x276 y180 w140 h25 +Center, Save Changes
	;	Gui, 2:Add, Text, x10 w280 +Center, TODO: Add Settings Menus
	
	
	Gui, 2:Show, w%width% h210 x%WinX% y%WinY%, Default Settings
