	...
	for objItem in ComObjGet("winmgmts:\\.\root\CIMV2").ExecQuery("SELECT * FROM Win32_NetworkAdapterConfiguration WHERE IPEnabled = True")
	{
		...
		if (objItem.IPAddress[0] = A_IPAddress1)
		{
			...
			MsgBox, 4096, %WinName%, % "Description:`t" objItem.Description[0] "`n"
						...
						. "DefaultIPGateway:`t`t" objItem.DefaultIPGateway[0] "`n"
			;. "DNS-Server:`t" (objItem.DNSServerSearchOrder[1] = "") ? objItem.DNSServerSearchOrder[0] : objItem.DNSServerSearchOrder[0] ", " objItem.DNSServerSearchOrder[1] "`n"
						...
						. "MACAddress:`t`t" objItem.MACAddress "`n"
						. "DHCPEnabled:`t`t" (objItem.DHCPEnabled[0] ? "Yes" : "No") "`n"
			Break
		}
	}
	Return
...
GuiCreate() {
	...
	Gui, Add, Picture, x245 y28 w25 h25 Icon19 gIpInfo, C:\WINDOWS\SYSTEM32\SHELL32.dll
	; Vertical Line
	Gui,  Add, Text, x280 y28 h35 0x11
	
	Gui, Add, Picture, x290 y28 w25 h25 Icon89 gNetInfo, C:\WINDOWS\SYSTEM32\SHELL32.dll
	Gui,  Add, Text, x490 y20 h35 0x11
	Gui, Add, Picture, x500 y25 w25 h25 Icon91 gChangeDefaults, C:\WINDOWS\SYSTEM32\SHELL32.dll
...
GuiSettings()
{
	...
	Gui, 2:Font, S9 CDefault Normal, Arial
	Gui, 2:Add, Text, x10 y10 w140 h20, RIP Key:
	Gui, 2:Add, Text, x170 yp w140 h20, DNS 1:
	Gui, 2:Add, Text, x330 yp w140 h20, DNS 2:
	Gui, 2:Font, S11 CDefault Normal, Courier
	Gui, 2:Add, Edit, x10 y27 w140 +Center, % Presets.rip
	Gui, 2:Add, Edit, x170 yp w140 +Center, % Presets.d1
	Gui, 2:Add, Edit, x330 yp w140 +Center, % Presets.d2
	
	Gui, 2:Font, S10 CDefault Bold, Arial
	Gui, 2:Add, Button, x170 y+20 w140 h25 +Center, Save
	
	;	Gui, 2:Add, Text, x10 w280 +Center, TODO: Add Settings Menus
	
	
	Gui, 2:Show, w%width% h100 x%WinX% y%WinY%, Default Settings
