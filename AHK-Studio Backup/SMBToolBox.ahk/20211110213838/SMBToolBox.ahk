...
AdaptersDDL: 
{
	...
	GuiControl, -ReadOnly, vGateway
	GuiControl, -ReadOnly, vUseableIP
...
GuiCreate() {
	...
	Gui, Font, S11 CDefault Normal, Courier
	Gui, Add, Edit, x%xCol_1% y%yTop_Row1_Obj% w160 vGateway +ReadOnly +Center
	Gui, Add, Edit, x%xCol_2% yp w160 vUseableIP +ReadOnly +Center
