...
GuiSettings()
{
	...
	Gui, 2:Tab, Scripts   ; enter tab 1
	Gui, 2:Add, Text, w140 h20, RIP Key:
	Gui, 2:Add, Text, xp+160 yp w140 h20, DNS 1:
	Gui, 2:Add, Text, xp+160 yp w140 h20, DNS 2:
	Gui, 2:Font, x20 S11 CDefault Normal, Courier
	Gui, 2:Add, Edit, yp+1 w140 +Center, % Presets.rip
