...
GuiCreate() {
	...
	Gui, Font, S11 CDefault Normal, Courier
	Gui, Add, Edit, x%xCol_1% y%yTop_Row1_Obj% w160 HWNDhGateway vGateway +Center
	...
	Gui, Add, Edit, x%xCol_2% y%yTop_Row2_Obj% w160 HWNDhDNSServer1 vDNSServer1 +ReadOnly +, % Presets.d1
	Gui, Add, Edit, x%xCol_3% y%yTop_Row2_Obj% w160 HWNDhDNSServer2 vDNSServer2 +ReadOnly +Center, % Presets.d1
