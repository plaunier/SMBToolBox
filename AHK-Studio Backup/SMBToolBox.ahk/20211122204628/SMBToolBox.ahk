...
GuiSettings()
{
	...
	Gui, 2:Add, Text, xp+150 yp w140 h20, DNS 1:
	Gui, 2:Add, Text, xp+150 yp w140 h20, DNS 2:
	Gui, 2:Font, S11 CDefault Normal, Courier
	Gui, 2:Add, Edit, x20 yp+17 w140 +Center, % Presets.rip
	Gui, 2:Add, Edit, xp+150 yp w140 +Center, % Presets.d1
	Gui, 2:Add, Edit, xp+150 yp w140 +Center, % Presets.d2
