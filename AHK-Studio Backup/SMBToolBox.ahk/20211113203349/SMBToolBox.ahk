...
ButtonDHCP:
{
	...
	IfMsgBox Yes
	{
		...
		Run, *RunAs PowerShell.exe -Command Get-NetIPAddress -InterfaceAlias '%AdaptersDDL%' | Remove-NetRoute `; Set-DnsClientServerAddress -InterfaceAlias '%AdaptersDDL%' -ResetServerAddresses 
